...
| `docs/ADR/ADR-0003-thesis-structure-standard.md` | Thesis structure standard — the ten-section format (hypothesis, valuation, catalysts, invalidation criteria) every topic-and-thesis write-up follows |
